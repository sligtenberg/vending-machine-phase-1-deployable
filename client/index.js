...
const populateSnackDisplay = () => {
    fetch('https://vending-machine-phase-1-deployable-app.onrender.com/snacks')
    .then(res => res.json())
...
const populateCashDrawer = () => {
    fetch('https://vending-machine-phase-1-deployable-app.onrender.com/cashes')
    .then(res => res.json())
    .then(cashDrawer => {
...
const updateSnackOnServer = snack => {
    fetch(`https://vending-machine-phase-1-deployable-app.onrender.com/snacks/${snack.id}`, {
        method: 'PATCH',
...
const sendMoneyInCashDrawer = moneyToSend => {
  moneyToSend.forEach(denomination => {
    fetch(`https://vending-machine-phase-1-deployable-app.onrender.com/cashes/${denomination.id}`, {
      method: 'PATCH',
      headers: {'Content-Type': 'application/json'},
